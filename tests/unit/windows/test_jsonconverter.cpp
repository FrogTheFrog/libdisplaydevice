...
TEST_F_S(SingleDisplayConfigState) {
  display_device::SingleDisplayConfigState valid_input {
    { { { "DeviceId1" } },
      { "DeviceId1" } },
  ...
  executeTestCase(display_device::SingleDisplayConfigState {}, R"({"initial":{"primary_devices":[],"topology":[]},"modified":null})");
